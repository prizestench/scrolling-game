...
public abstract class Entity {
    ...
    public boolean isCollidingWith(Entity other){
        ...
        // Check if player is to the left of other
        if (this.getX() + this.getWidth() < other.getX()) {
            return false;
        }
        
        // Check if player is to the right of other
        else if (this.getX() > other.getX() + other.getWidth()) {
            return false;
        }
        
        // Check if player is above other
        else if (this.getY() + this.getHeight() < other.getY()) {
            return false;
        }
        
        // Check if player is below other
        else if (this.getY() > other.getY() + other.getHeight()) {
            return false;
        }
        
        // If none of the above conditions are met, the entities are colliding
        return true;
